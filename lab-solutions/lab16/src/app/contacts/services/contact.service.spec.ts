...
describe('Service: ContactService', () => {
	...
	beforeEach(() => {
		httpMock = {
			get: vi.fn().mockReturnValue(of([createContact()])),
			post: vi.fn(),
			put: vi.fn().mockReturnValue(of(createContact())),
			delete: vi.fn(),
	...
	it('updates a contact', async () => {
		const contact = createContact({ id: 4, firstName: 'John', surname: 'Doe', email: 'john@doe.com' });
